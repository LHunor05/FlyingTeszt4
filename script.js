...
function warning() {
    ...
    while (true) {
        ...
        if (result) {
            document.getElementsByClassName('flight-aa-kep')[0].style.opacity = 1;
            break
        }
        else {
...
function TermsConditions() {
    ...
    <ol>
        ...
        <li><strong>Contact:</strong> For any inquiries or concerns about your data, you can contact us via email@example.com.</li>
    </ol>
    <br>
